from attacks import wrap_attack, wrap_cw_linf, wrap_attack_FW, ifgsm, momentum_ifgsm, fgsm, deepfool, CW_Linf, FW_vanilla_batch,  Transferable_Adversarial_Perturbations, ILA
...
attack_configs ={ 
    ...
    attack_name(FW_vanilla_batch): wrap_attack_FW(FW_vanilla_batch, {'normalizer': normalize, 'device': 'cuda', 'radius': 1.0}),
