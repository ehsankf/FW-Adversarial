...
'''
Usage:
python all_in_one_imagenet.py --source_models ResNet18 --transfer_models ResNet18 DenseNet121 SqueezeNet1.0 alexnet --out_name=testimagenet.csv  --attacks FW_vanilla_batch --num_batches=50 --batch_size=32
'''
