...
"""
python utils.py --adver_file adv_inputs/CIFAR100_LBGAT_FW_attack_standard_1_10000_eps_3.00000.pth --intensity --adver_file_helper adv_inputs/CIFAR100_LBGAT_auto_attack_standard_1_10000_eps_0.06275.pth
"""
...
if __name__ == '__main__':
    ...
    if args.intensity: 
        ...
        ax1.hist(np.abs(np.mean(stat_dict['adv_complete'] - stat_dict['x_test'], axis=0)).ravel(), bins = 25, 
        ...
        if args.adver_file_helper: 
            ...
            ax1.hist(np.abs(np.mean(stat_dict['adv_complete'] - stat_dict['x_test'], axis=0)).ravel(), bins = 25,
            color = 'tab:green', label = legends[1], alpha = 0.5)
        ...
        FID = calculate_frechet_distance(stat_dict['x_test'], stat_dict['adv_complete'])
