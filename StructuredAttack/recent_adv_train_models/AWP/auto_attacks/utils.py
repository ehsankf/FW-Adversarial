...
"""
python utils.py --adver_file adv_inputs/CIFAR100_AWP_FW_attack_standard_1_10000_eps_5.00000.pth --intensity --adver_file_helper adv_inputs/CIFAR100_LBGAT_auto_attack_standard_1_10000_eps_0.06275.pth
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epsinf', type=str, default=None)
    parser.add_argument('--epsnuc', type=str, default=None)
    ...
    if args.intensity: 
        ...
        legends = [r'FWnucl $\epsilon_{S1} = $' + f'{args.epsnuc}', r'Auto-Attack $\epsilon = $' + f'{args.epsinf}']
        ...
        ax1.hist(256 * perturbation, bins = bin_nums, 
                  color = 'tab:blue', label = legends[0])
        ...
        if args.adver_file_helper: 
            ...
            bin_nums = np.int((max(perturbation) - min(perturbation)) / bar_width)
            ax1.hist(256 * perturbation, bins = bin_nums,
            color = 'tab:red', label = legends[1], alpha = 0.5)
