...
checkpoint_dict = {'CIFAR10': {'AWP': '../pretrained_models/AT-AWP_cifar10_linf_wrn34-10.pth', 'TRADES-AWP': '../pretrained_models/TRADES-AWP_cifar10_linf_wrn34-10.pt',
                               'LBGAT': '../../LBGAT/pretrained_models/cifar10_lbgat0_wideresnet34-10.pt'}, 
                               'CIFAR100': {'AWP': '../pretrained_models/AT-AWP_cifar100_linf_wrn34-10.pth', 'TRADES-AWP': '../pretrained_models/TRADES-AWP_cifar100_linf_wrn34-10.pt',
                                'LBGAT': '../../LBGAT/pretrained_models/cifar100_lbgat0_wideresnet34-10.pt'}}

preprocess_dict = {'AWP':'meanstd', 'TRADES-AWP': '01', 'LBGAT': '01'}
...
if __name__ == '__main__':
    ...
    for attack in ['FW_attack']:
     for epsilon in epsilons_dict[attack]:
        nat_acc1 = eval_test(model, test_loader, device)
        ...
        torch.save({'x_test': x_test.detach().cpu().numpy(), 'y_test': y_test.detach().cpu().numpy(), \
                'adv_complete': adv_complete.detach().cpu().numpy(), 'nat_acc': nat_acc, 'nat_acc1': nat_acc1, 'adv_acc': adv_acc,
