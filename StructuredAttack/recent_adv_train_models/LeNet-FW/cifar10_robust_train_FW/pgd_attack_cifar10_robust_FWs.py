...
parser.add_argument('--model', default='ResNet18', help='models to train (default small_cnn')
...
parser.add_argument('--model-path',
                    default='net_robust_adversarial_FW/net_epoch30.ckpt',
...
if __name__ == '__main__':
        ...
        args.model = 'ResNet18'
        args.model_path = 'ResNet_robust_adversarial_eps3_FW/net_epoch70.ckpt' # 'net_robust_adversarial_FW/net_epoch30.ckpt' #'../../../../attack_cifar10/Madry-PGD-Linf/ResNet18/checkpoint.pt.best'
