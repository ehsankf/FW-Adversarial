 ...
 #   gpu_options = tf.GPUOptions(per_process_gpu_memory_fraction=0.7)
    with tf.Session() as sess:
        ...
        if args['dataset'] == "cifar":
            data, model = CIFAR(), CIFARModel("models/cifar.h5", sess)
        ...
        inputs, targets, labels, true_ids = generate_data(data, model, samples=args['numimg'], targeted=False, target_num=args['target_number'],
