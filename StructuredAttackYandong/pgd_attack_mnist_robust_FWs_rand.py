...
def main(eps):
        ...
        pgd_params = {'attack': 'FW', 'epsilon': eps, 'num_steps': 10, 'step_size': 1,
...
if __name__ == '__main__':
        ...
        args.model = 'Net'
        # args.model_path = 'recent_adv_train_models/LeNet-FW/mnist/2a1b45fd-2f85-4928-930b-96e7d1640dc1/checkpoint.pt.latest'
        args.model_path = 'recent_adv_train_models/LeNet-FW/net_robust_adversarial_FW/net_adver_game_epoch50.ckpt'
        main(eps=1)
