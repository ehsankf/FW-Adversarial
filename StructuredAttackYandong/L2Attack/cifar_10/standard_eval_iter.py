...
checkpoint_dict = {'CIFAR10': {'AWP': '../pretrained_models/AT-AWP_cifar10_linf_wrn34-10.pth', 
                               ...
                               'ResNet50L2': '/data/ehsan/Adv-Ex/test_attack2/test-attackYan/attack_cifar10/Madry-PGD-L2/ResNet50/cifar_l2_0_5.pt',
                               'WideResNetL2': '/data/ehsan/Adv-Ex/test_attack2/test-attackYan/attack_cifar10/Madry-PGD-L2/WideResNet/checkpoint.pt.best', 
                               'ResNet18L2': '/data/ehsan/Adv-Ex/test_attack2/test-attackYan/attack_cifar10/Madry-PGD-L2/ResNet18/checkpoint.pt.best'}, 
                   'CIFAR100': {'AWP': '../pretrained_models/AT-AWP_cifar100_linf_wrn34-10.pth', 
                                'LBGAT': '../../LBGAT/pretrained_models/cifar100_lbgat0_wideresnet34-10.pt'}}
preprocess_dict = {'Standard': 'meanstd', 'AWP': 'meanstd', 'LBGAT': '01', 'ResNet50L2': 'meanstd', 'ResNet18L2': 'meanstd', 'WideResNetL2':' meanstd'}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', type=str, default='WideResNet34',
                        choices=['WideResNet28', 'WideResNet34', 'PreActResNet18', 'ResNet50', 'ResNet18'])
    ...
    parser.add_argument('--train_model', type=str, default='AWP', choices=['AWP', 'LBGAT', 'Standard', 'ResNet18L2'],
    ...
    if args.preprocess == 'meanstd':
        if args.data == 'CIFAR10' and args.train_model in ['Standard', 'ResNet50L2', 'ResNet18L2', 'WideResNetL2']:
    ...
    epsilons_dict = {'auto_attack': [2./255., 4./255., 8./255.] if args.norm == 'Linf' else [1.0, 1.5, 2.0], 'FW_attack': [1., 1.5, 2.5, 3., 5.]}    
    # for attack in ['FW_attack', 'auto_attack']:
    for attack in ['FW_attack']:
