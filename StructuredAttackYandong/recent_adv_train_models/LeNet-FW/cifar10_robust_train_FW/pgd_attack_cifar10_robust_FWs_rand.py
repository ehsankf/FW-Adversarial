...
def main():
    ...
    if adv_atc == 'pgdl2': 
      for eps in [0.5, 1.0, 1.5]:   
        pgd_params = {'attack': 'pgdl2', 'epsilon': eps, 'num_steps': 3, 'step_size': 0.1,
    ...
    if adv_atc == 'FW':
      for eps in [1.0, 3.0, 5.0]:
        step_size =  1
        pgd_params = {'attack': 'FW', 'epsilon': eps, 'num_steps': 3, 'step_size': step_size,
...
if __name__ == '__main__':
        ...
        for adv_atc in ['FW', 'pgdl2']:
            ...
            main()    
        """
        for adv_atc in ['auto-attack', 'auto-attackL2']:
        # for adv_atc in ['pgd']:
            args.model = 'ResNet18'
            # args.model_path = 'net_robust_adversarial_eps3_FW/net_epoch150.ckpt'
            # args.model_path = 'net_robust_adversarial_FW_eps5_iter10/net_epoch170.ckpt'
            args.model_path = 'net_robust_adversarial_FW/net_epoch190.ckpt'
            main()
