...
def train():
    ...
    for epoch in range(args.epoch):
        ...
        if epoch % args.num_ckpt_steps == 0:
            ...
            save_checkpoint(net, 0.0, epoch, 'net_robust_adversarial_eps3_FW/')
        schedule.step()
...
if __name__ == '__main__':
        ...
        pgd_params = {'attack': 'FW', 'epsilon': args.epsilon, 'num_steps': 5, 'step_size': 3,
        ...
        args.model_path = '../../../../attack_cifar10/Madry-FW/ResNet18/checkpointeps5iter20.pt.best'
        net_src = load_model()
        net_src = ResNet18()
