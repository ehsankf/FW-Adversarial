...
if __name__ == '__main__':
        ...
        for adv_atc in ['FW', 'pgdl2', 'pgd']:
            args.model = 'SmallCNN'
            args.model_path = 'SmallCNN_robust_adversarial_eps5_FW/net_epoch190.ckpt'
            main()
        """
        # for adv_atc in ['FW', 'pgdl2']:
        for adv_atc in ['FW', 'pgdl2', 'pgd']:
            args.model = 'SmallCNN'
            args.model_path = 'SmallCNN_robust_adversarial_eps3_FW/SmallCNN_robust_adversarial_eps3_FWnet_epoch190.ckpt'
            main()
        """
